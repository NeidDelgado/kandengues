<div class="conteudo_geral">
    ...
    <div id="main-h">
       <span title="<?php echo $magazine['Magazine']['title'] ?>"><p class="img">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<?php echo $this->Html->image("/files/magazine/image/{$magazine['Magazine']['id']}/". $magazine['Magazine']['image'], array('escape' => false)); ?></p></span> 
         <div class='hist-ver' >  
            <H1>&nbsp; &nbsp; <?php echo $magazine['Magazine']['title'] ?></H1>
            <h4 ><?php  echo  $magazine['Magazine']['description'] ?></h4>
         </div> <div class="clear"></div>
         <p class='img'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<?php  echo $this->Html->link('Downloads', "/files/{$magazine['Magazine']['title']}.pdf", array( 'target' => "_blank", 'escape' => false));?></p>
        <p class='img'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php  echo $this->Html->link($this->Html->image('voltar.png') .'Voltar', '/magazines/lista', array('escape' => false));
        ?></p><br><br><br><br>
       </div>
