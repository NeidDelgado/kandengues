<div class="conteudo_geral">
    <div class="admin_contentform left">
        <div class="form">
            <fieldset>
             <h1>Novo Conselho</h1>
                <?php echo $this->Form->create('Conselho', array('type' => 'file')); ?>
                <div class="field">
                    <?php echo $this->Form->input('Conselho.title', array( 'placeholder'=>'Titulo','required')); ?>
                    <p class="hint">Insira o Titulo.</p>
                </div>
                <div  class="field">
                    <p class="input-text"><?php echo $this->Form->input('Conselho.image', array('type' => 'file')); ?></p>
                </div>
                    <?php echo $this->Form->input('Conselho.image_dir', array('type' => 'hidden')); ?>
