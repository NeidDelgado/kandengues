(function($){ // Main code
	$(document).ready(function(){
		...
		var navigator = new Navigator({
			...
			nextButton: '.arrowss.next',
			prevButton: '.arrowss.prev',
			shuffle: true
		});
	...
	function Navigator(config) {
		...
		this.init = function () {
			...
			self.carousell.addClass('active');
		}
