(function($){ // Main code
	$(document).ready(function(){
		...
		var navigator = new Navigator({
			carousell: '#carousell',
			nextButton: '.arrows.next',
			prevButton: '.arrows.prev',
			shuffle: true
		});
	...
	function Navigator(config) {
		...
		this.carousell = $(config.carousell); //the carousel element
		...
		//private variables
		this._items = $(config.carousell + ' li'); //all the items in the carousel
